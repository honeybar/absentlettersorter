...
include("update_absentees.php"); // link this page to update_absentees.phpy
?>
		...
		$search=mysql_query("SELECT DISTINCT absent_letter.date AS date
							...
							letters_given='0' AND studentlisttbl.Class_ID='$classid'
							ORDER by date DESC"); 
	...
	?>
    	...
    	<table width="300" border="0" align="right" class="table">
      		<tr>
        		...
        		<td align="right">missing letters</td>
