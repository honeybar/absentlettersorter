<?php
		include("discpline_session.php");		
  	  	$d1=$_GET["date1"]; // get date1 from generateweekrep.php
	  	$d2=$_GET["date2"]; // get date2 from generateweekrep.php
	  	include("connection.php"); // link connection.php to this page
	  	include("generaterepsettings.php"); // link generaterepsettings.php
	  ...
	  $average=round($totalabsentees/$diff,1); // average no of absentees per day
